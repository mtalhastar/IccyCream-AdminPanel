...
const Form = () => {
  ...
  return (
    <form className="p-10" >
        ...
        <button className="bg-black hover:bg-gray-900 mt-7 h-10 text-white font-bold rounded-full w-full  mx-auto" onClick={Submit}>Login</button>
        </div>
        </form>
  )
}
